...
class CalculationsController extends Controller
{
 ...
 $matrix = [];
        ...
        return view('calculation', compact('decisionMatrix', 'normMatrix', 'weightedNorm', 'idealPositive', 'idealNegative', 'solutionPositive', 'solutionNegative', 'PreferenceValue', 'criteria', 'alternatives','matrix'));
    }
